...
INSERT INTO `cattipoprenda` VALUES (1,'Falda'),(2,'Playera'),(3,'Blusa'),(4,'Pantalón'),(5,'Short'),(6,'Accesorio'),(7,'Gorro/Gorra'),(8,'Sueter'),(9,'Sudadera'),(10,'Chamarra'),(11,'Otro');
...
CREATE TABLE `prenda` (
  ...
  `intercambiable` varchar(1) DEFAULT NULL,
...
INSERT INTO `prenda` VALUES (1,1,9,3,'Uploads/Prendas/sudaderaMarbella.PNG','Esta prenda me encanta, hace poco le cayó un poco de cloro en las mangas, pero les juro no se nota y está preciosa','500.00','N','S');
...
INSERT INTO `usuario` VALUES (1,'Marbella','Velazquez','marbella.velazquez@gmail.com','MarbellaVelazquez','perro','Uploads/marbella.jpg','192.168.21.18',NULL);
...
-- Dump completed on 2018-03-15 10:27:38
